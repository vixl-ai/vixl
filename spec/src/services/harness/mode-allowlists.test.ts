...
describe('mode allowlists codebase tools', () => {
  ...
  it('includes codebase tools in ask, plan, agent, and orchestrator', () => {
...
describe('mode allowlists resolve_models', () => {
  ...
  it('includes resolve_models in ask and plan', () => {
...
describe('mode allowlists spawn_subagent', () => {
  it('includes spawn_subagent in ask, plan, agent, and orchestrator', () => {
...
describe('mode allowlists mcp tools', () => {
  ...
  it('includes mcp tools in ask and plan', () => {
...
describe('mode allowlists update_todos', () => {
  ...
  it('excludes update_todos from ask and plan', () => {
...
describe('mode allowlists web_fetch', () => {
  it('includes web_fetch in ask, plan, agent, and orchestrator', () => {
