---
name: plan
description: Research and write PLAN.md. No source mutations. No shell. Read-only subagents, MCP, and browser are allowed.
---
...
- Use read-only spawn_subagent, MCP, and browser for structural research before create_plan.
