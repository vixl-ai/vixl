...
use commands::{
  ...
  has_project_vixl, http_proxy_request, http_proxy_stream, http_proxy_stream_cancel, list_chats,
  web_fetch,
  ...
  shell_write_pty, update_chat_meta, watch_vixl_paths, workspace_glob, workspace_grep,
